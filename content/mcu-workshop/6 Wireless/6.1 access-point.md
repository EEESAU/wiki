...
# Exercises
> [!exercise]
> The HTML that defines how the page looks is defined in the first few lines of `picow_access_point.c`. If you know CSS, can you spruce it up a bit to make it look nicer?
...
> 
> Think about controlling some of the other components that we have covered in this workshop.
